...
?_002:  sub     esp, 12                                 ; 031D _ 83. EC, 0C
        ...
        jne near      ?_001                                   ; 034d _ 0f 85, ffffff32
        ...
        jle near      ?_001                                   ; 0395 _ 0f 8e, fffffeea
...
?_027:  cmp     dword [ebp-4H], 15                      ; 0A84 _ 83. 7D, FC, 0F
        jle near      ?_018                                   ; 0a88 _ 0f 8e, fffffe94
        nop                                             ; 0A8E _ 90
        nop                                             ; 0A8F _ 90
        leave                                           ; 0A90 _ C9
        ret                                             ; 0A91 _ C3
...
?_046:  cmp     dword [ebp-8H], 1                       ; 0D22 _ 83. 7D, F8, 01
        jle near      ?_047                                   ; 0d26 _ 7e, 06
        cmp     dword [ebp+8H], 0                       ; 0D28 _ 83. 7D, 08, 00
        jnz near      ?_043                                   ; 0d2c _ 75, b3
...
mouse_decode:; Function begin
        ...
        jnz near      ?_051                                   ; 0e27 _ 75, 17
        cmp     byte [ebp-4H], -6                       ; 0E29 _ 80. 7D, FC, FA
        jnz near      ?_050                                   ; 0e2d _ 75, 07
...
?_054:  mov     eax, dword [ebp+8H]                     ; 0E95 _ 8B. 45, 08
        ...
        jne near      ?_057                                   ; 0e9d _ 0f 85, 0000009c
...
?_072:  mov     eax, dword [ebp+8H]                     ; 159F _ 8B. 45, 08
        ...
        jc near       ?_069                                   ; 15a7 _ 0f 82, ffffff6e
...
?_077:  cmp     dword [ebp-8H], 0                       ; 15E5 _ 83. 7D, F8, 00
        jle near      ?_079                                   ; 15e9 _ 0f 8e, 000000ba
        ...
        jne near      ?_079                                   ; 1613 _ 0f 85, 00000090
...
?_080:  mov     eax, dword [ebp+8H]                     ; 1705 _ 8B. 45, 08
        ...
        jg  near      ?_084                                   ; 170f _ 0f 8f, 00000086
...
?_096:  mov     eax, dword [ebp+0CH]                    ; 19C2 _ 8B. 45, 0C
        ...
        jle near      ?_103                                   ; 19d1 _ 0f 8e, 000001d3
        cmp     dword [ebp+10H], 0                      ; 19D7 _ 83. 7D, 10, 00
        js near       ?_099                                   ; 19db _ 0f 88, 000000e1
...
?_103:  mov     eax, dword [ebp-10H]                    ; 1BAA _ 8B. 45, F0
        ...
        jge near      ?_110                                   ; 1bb0 _ 0f 8d, 00000145
        cmp     dword [ebp-10H], 0                      ; 1BB6 _ 83. 7D, F0, 00
        js near       ?_106                                   ; 1bba _ 78, 55
...
sheet_slide:; Function begin
        ...
        js near       ?_112                                   ; 1da9 _ 0f 88, 000000d3
...
?_123:  mov     eax, dword [ebp-4H]                     ; 1FFC _ 8B. 45, FC
        ...
        jle near      ?_117                                   ; 2002 _ 0f 8e, fffffee6
        nop                                             ; 2008 _ 90
        nop                                             ; 2009 _ 90
        leave                                           ; 200A _ C9
        ret                                             ; 200B _ C3
...
?_138:  mov     eax, dword [ebp+8H]                     ; 219F _ 8B. 45, 08
        ...
        jle near      ?_128                                   ; 21a8 _ 0f 8e, fffffeba
        nop                                             ; 21AE _ 90
        leave                                           ; 21AF _ C9
        ret                                             ; 21B0 _ C3
