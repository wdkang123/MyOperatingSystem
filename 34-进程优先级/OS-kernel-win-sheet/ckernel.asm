...
?_002:  cmp     dword [ebp-14H], 1                      ; 04ED _ 83. 7D, EC, 01
        jle near      ?_001                                   ; 04f1 _ 0f 8e, fffffe6e
...
?_004:  sub     esp, 12                                 ; 05BD _ 83. EC, 0C
        ...
        je near       ?_006                                   ; 05cf _ 0f 84, 00000186
        ...
        jle near      ?_003                                   ; 063d _ 0f 8e, ffffff34
...
?_005:  mov     eax, dword [ebp-44H]                    ; 064F _ 8B. 45, BC
        ...
        je near       ?_003                                   ; 065b _ 0f 84, ffffff16
        cmp     dword [ebp-0CH], 143                    ; 0661 _ 81. 7D, F4, 0000008F
        jg  near      ?_003                                   ; 0668 _ 0f 8f, ffffff09
...
?_007:  sub     esp, 12                                 ; 0793 _ 83. EC, 0C
        ...
        je near       ?_003                                   ; 07a5 _ 0f 84, fffffdcc
        ...
        jle near      ?_003                                   ; 0808 _ 0f 8e, fffffd69
        cmp     dword [ebp-20H], 0                      ; 080E _ 83. 7D, E0, 00
        jne near      ?_003                                   ; 0812 _ 0f 85, fffffd5f
...
?_036:  cmp     dword [ebp-4H], 15                      ; 1125 _ 83. 7D, FC, 0F
        jle near      ?_027                                   ; 1129 _ 0f 8e, fffffe94
        nop                                             ; 112F _ 90
        nop                                             ; 1130 _ 90
        leave                                           ; 1131 _ C9
        ret                                             ; 1132 _ C3
...
?_055:  cmp     dword [ebp-8H], 1                       ; 13C3 _ 83. 7D, F8, 01
        jle near      ?_056                                   ; 13c7 _ 7e, 06
        cmp     dword [ebp+8H], 0                       ; 13C9 _ 83. 7D, 08, 00
        jnz near      ?_052                                   ; 13cd _ 75, b3
...
mouse_decode:; Function begin
        ...
        jnz near      ?_060                                   ; 14c8 _ 75, 17
        cmp     byte [ebp-4H], -6                       ; 14CA _ 80. 7D, FC, FA
        jnz near      ?_059                                   ; 14ce _ 75, 07
...
?_063:  mov     eax, dword [ebp+8H]                     ; 1536 _ 8B. 45, 08
        ...
        jne near      ?_066                                   ; 153e _ 0f 85, 0000009c
...
?_081:  mov     eax, dword [ebp+8H]                     ; 1D53 _ 8B. 45, 08
        ...
        jc near       ?_078                                   ; 1d5b _ 0f 82, ffffff6e
...
?_086:  cmp     dword [ebp-8H], 0                       ; 1D99 _ 83. 7D, F8, 00
        jle near      ?_088                                   ; 1d9d _ 0f 8e, 000000ba
        ...
        jne near      ?_088                                   ; 1dc7 _ 0f 85, 00000090
...
?_089:  mov     eax, dword [ebp+8H]                     ; 1EB9 _ 8B. 45, 08
        ...
        jg  near      ?_093                                   ; 1ec3 _ 0f 8f, 00000086
...
?_105:  mov     eax, dword [ebp+0CH]                    ; 2176 _ 8B. 45, 0C
        ...
        jle near      ?_112                                   ; 2185 _ 0f 8e, 000001d3
        cmp     dword [ebp+10H], 0                      ; 218B _ 83. 7D, 10, 00
        js near       ?_108                                   ; 218f _ 0f 88, 000000e1
...
?_112:  mov     eax, dword [ebp-10H]                    ; 235E _ 8B. 45, F0
        ...
        jge near      ?_119                                   ; 2364 _ 0f 8d, 00000145
        cmp     dword [ebp-10H], 0                      ; 236A _ 83. 7D, F0, 00
        js near       ?_115                                   ; 236e _ 78, 55
...
sheet_slide:; Function begin
        ...
        js near       ?_121                                   ; 255d _ 0f 88, 000000d3
...
?_132:  mov     eax, dword [ebp-4H]                     ; 27B0 _ 8B. 45, FC
        ...
        jle near      ?_126                                   ; 27b6 _ 0f 8e, fffffee6
        nop                                             ; 27BC _ 90
        nop                                             ; 27BD _ 90
        leave                                           ; 27BE _ C9
        ret                                             ; 27BF _ C3
...
?_147:  mov     eax, dword [ebp+8H]                     ; 2953 _ 8B. 45, 08
        ...
        jle near      ?_137                                   ; 295c _ 0f 8e, fffffeba
        nop                                             ; 2962 _ 90
        leave                                           ; 2963 _ C9
        ret                                             ; 2964 _ C3
...
?_154:  mov     eax, dword [ebp-0CH]                    ; 2AAD _ 8B. 45, F4
        ...
        jne near      ?_155                                   ; 2abd _ 0f 85, 00000084
...
?_157:  cmp     dword [ebp-0CH], 499                    ; 2B55 _ 81. 7D, F4, 000001F3
        jle near      ?_154                                   ; 2b5c _ 0f 8e, ffffff4b
        nop                                             ; 2B62 _ 90
        leave                                           ; 2B63 _ C9
        ret                                             ; 2B64 _ C3
...
?_168:  cmp     dword [ebp-0CH], 4                      ; 2E3F _ 83. 7D, F4, 04
        jle near      ?_167                                   ; 2e43 _ 0f 8e, ffffff56
...
?_169:  mov     ecx, dword [taskctl]                    ; 2ED6 _ 8B. 0D, 000022C8(d)
        ...
        jne near      ?_170                                   ; 2efa _ 0f 85, 000000d0
...
?_171:  cmp     dword [ebp-4H], 4                       ; 2FD3 _ 83. 7D, FC, 04
        jle near      ?_169                                   ; 2fd7 _ 0f 8e, fffffef9
...
task_sleep:; Function begin
        ...
        jne near      ?_184                                   ; 30c6 _ 0f 85, 000000e9
