...
?_002:  sub     esp, 12                                 ; 03C8 _ 83. EC, 0C
        ...
        je near       ?_004                                   ; 03da _ 0f 84, 00000186
        ...
        jle near      ?_001                                   ; 0448 _ 0f 8e, ffffff34
...
?_003:  mov     eax, dword [ebp-40H]                    ; 045A _ 8B. 45, C0
        ...
        je near       ?_001                                   ; 0466 _ 0f 84, ffffff16
        cmp     dword [ebp-0CH], 143                    ; 046C _ 81. 7D, F4, 0000008F
        jg  near      ?_001                                   ; 0473 _ 0f 8f, ffffff09
...
?_005:  sub     esp, 12                                 ; 059E _ 83. EC, 0C
        ...
        je near       ?_001                                   ; 05b0 _ 0f 84, fffffdcc
        ...
        jle near      ?_001                                   ; 0613 _ 0f 8e, fffffd69
        cmp     dword [ebp-1CH], 0                      ; 0619 _ 83. 7D, E4, 00
        jne near      ?_001                                   ; 061d _ 0f 85, fffffd5f
...
?_011:  sub     esp, 12                                 ; 08F6 _ 83. EC, 0C
        ...
        jg  near      ?_010                                   ; 0911 _ 7f, c4
        cmp     dword [ebp-1CH], 0                      ; 0913 _ 83. 7D, E4, 00
        jz near       ?_012                                   ; 0917 _ 74, 1d
...
?_038:  cmp     dword [ebp-4H], 15                      ; 115A _ 83. 7D, FC, 0F
        jle near      ?_029                                   ; 115e _ 0f 8e, fffffe94
        nop                                             ; 1164 _ 90
        nop                                             ; 1165 _ 90
        leave                                           ; 1166 _ C9
        ret                                             ; 1167 _ C3
...
?_057:  cmp     dword [ebp-8H], 1                       ; 13F8 _ 83. 7D, F8, 01
        jle near      ?_058                                   ; 13fc _ 7e, 06
        cmp     dword [ebp+8H], 0                       ; 13FE _ 83. 7D, 08, 00
        jnz near      ?_054                                   ; 1402 _ 75, b3
...
mouse_decode:; Function begin
        ...
        jnz near      ?_062                                   ; 14fd _ 75, 17
        cmp     byte [ebp-4H], -6                       ; 14FF _ 80. 7D, FC, FA
        jnz near      ?_061                                   ; 1503 _ 75, 07
...
?_065:  mov     eax, dword [ebp+8H]                     ; 156B _ 8B. 45, 08
        ...
        jne near      ?_068                                   ; 1573 _ 0f 85, 0000009c
...
?_083:  mov     eax, dword [ebp+8H]                     ; 1D88 _ 8B. 45, 08
        ...
        jc near       ?_080                                   ; 1d90 _ 0f 82, ffffff6e
...
?_088:  cmp     dword [ebp-8H], 0                       ; 1DCE _ 83. 7D, F8, 00
        jle near      ?_090                                   ; 1dd2 _ 0f 8e, 000000ba
        ...
        jne near      ?_090                                   ; 1dfc _ 0f 85, 00000090
...
?_091:  mov     eax, dword [ebp+8H]                     ; 1EEE _ 8B. 45, 08
        ...
        jg  near      ?_095                                   ; 1ef8 _ 0f 8f, 00000086
...
?_107:  mov     eax, dword [ebp+0CH]                    ; 21AB _ 8B. 45, 0C
        ...
        jle near      ?_114                                   ; 21ba _ 0f 8e, 000001d3
        cmp     dword [ebp+10H], 0                      ; 21C0 _ 83. 7D, 10, 00
        js near       ?_110                                   ; 21c4 _ 0f 88, 000000e1
...
?_114:  mov     eax, dword [ebp-10H]                    ; 2393 _ 8B. 45, F0
        ...
        jge near      ?_121                                   ; 2399 _ 0f 8d, 00000145
        cmp     dword [ebp-10H], 0                      ; 239F _ 83. 7D, F0, 00
        js near       ?_117                                   ; 23a3 _ 78, 55
...
sheet_slide:; Function begin
        ...
        js near       ?_123                                   ; 2592 _ 0f 88, 000000d3
...
?_134:  mov     eax, dword [ebp-4H]                     ; 27E5 _ 8B. 45, FC
        ...
        jle near      ?_128                                   ; 27eb _ 0f 8e, fffffee6
        nop                                             ; 27F1 _ 90
        nop                                             ; 27F2 _ 90
        leave                                           ; 27F3 _ C9
        ret                                             ; 27F4 _ C3
...
?_149:  mov     eax, dword [ebp+8H]                     ; 2988 _ 8B. 45, 08
        ...
        jle near      ?_139                                   ; 2991 _ 0f 8e, fffffeba
        nop                                             ; 2997 _ 90
        leave                                           ; 2998 _ C9
        ret                                             ; 2999 _ C3
...
?_156:  mov     eax, dword [ebp-0CH]                    ; 2AE2 _ 8B. 45, F4
        ...
        jne near      ?_157                                   ; 2af2 _ 0f 85, 00000084
...
?_159:  cmp     dword [ebp-0CH], 499                    ; 2B8A _ 81. 7D, F4, 000001F3
        jle near      ?_156                                   ; 2b91 _ 0f 8e, ffffff4b
        nop                                             ; 2B97 _ 90
        leave                                           ; 2B98 _ C9
        ret                                             ; 2B99 _ C3
...
?_172:  cmp     dword [ebp-0CH], 4                      ; 2EF5 _ 83. 7D, F4, 04
        jle near      ?_171                                   ; 2ef9 _ 0f 8e, ffffff56
...
?_175:  mov     ecx, dword [taskctl]                    ; 2FA7 _ 8B. 0D, 000022A8(d)
        ...
        jne near      ?_176                                   ; 2fcb _ 0f 85, 000000d0
...
?_177:  cmp     dword [ebp-4H], 4                       ; 30A4 _ 83. 7D, FC, 04
        jle near      ?_175                                   ; 30a8 _ 0f 8e, fffffef9
...
?_184:  mov     eax, dword [ebp-0CH]                    ; 31BB _ 8B. 45, F4
        ...
        jz near       ?_185                                   ; 31eb _ 74, 1a
        cmp     dword [ebp-14H], 0                      ; 31ED _ 83. 7D, EC, 00
        jz near       ?_185                                   ; 31f1 _ 74, 14
