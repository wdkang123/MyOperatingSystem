...
?_002:  sub     esp, 12                                 ; 0349 _ 83. EC, 0C
        ...
        jle     ?_001                                   ; 03C1 _ 0F 8E, FFFFFF3C
...
?_003:  mov     eax, dword [ebp-3CH]                    ; 03D3 _ 8B. 45, C4
        ...
        je      ?_001                                   ; 03DF _ 0F 84, FFFFFF1E
        cmp     dword [ebp-0CH], 143                    ; 03E5 _ 81. 7D, F4, 0000008F
        jg      ?_001                                   ; 03EC _ 0F 8F, FFFFFF11
...
?_032:  cmp     dword [ebp-4H], 15                      ; 0CC0 _ 83. 7D, FC, 0F
        jle     ?_023                                   ; 0CC4 _ 0F 8E, FFFFFE94
        nop                                             ; 0CCA _ 90
        nop                                             ; 0CCB _ 90
        leave                                           ; 0CCC _ C9
        ret                                             ; 0CCD _ C3
...
?_051:  cmp     dword [ebp-8H], 1                       ; 0F5E _ 83. 7D, F8, 01
        jle     ?_052                                   ; 0F62 _ 7E, 06
        cmp     dword [ebp+8H], 0                       ; 0F64 _ 83. 7D, 08, 00
        jnz     ?_048                                   ; 0F68 _ 75, B3
...
mouse_decode:; Function begin
        ...
        jnz     ?_056                                   ; 1063 _ 75, 17
        cmp     byte [ebp-4H], -6                       ; 1065 _ 80. 7D, FC, FA
        jnz     ?_055                                   ; 1069 _ 75, 07
...
?_059:  mov     eax, dword [ebp+8H]                     ; 10D1 _ 8B. 45, 08
        ...
        jne     ?_062                                   ; 10D9 _ 0F 85, 0000009C
...
?_082:  cmp     dword [ebp-8H], 0                       ; 19E8 _ 83. 7D, F8, 00
        jle     ?_084                                   ; 19EC _ 0F 8E, 000000BA
        ...
        jne     ?_084                                   ; 1A16 _ 0F 85, 00000090
...
?_101:  mov     eax, dword [ebp+0CH]                    ; 1DC5 _ 8B. 45, 0C
        ...
        jle     ?_108                                   ; 1DD4 _ 0F 8E, 000001D3
        cmp     dword [ebp+10H], 0                      ; 1DDA _ 83. 7D, 10, 00
        js      ?_104                                   ; 1DDE _ 0F 88, 000000E1
...
?_108:  mov     eax, dword [ebp-10H]                    ; 1FAD _ 8B. 45, F0
        ...
        jge     ?_115                                   ; 1FB3 _ 0F 8D, 00000145
        cmp     dword [ebp-10H], 0                      ; 1FB9 _ 83. 7D, F0, 00
        js      ?_111                                   ; 1FBD _ 78, 55
...
?_128:  mov     eax, dword [ebp-4H]                     ; 23FF _ 8B. 45, FC
        ...
        jle     ?_122                                   ; 2405 _ 0F 8E, FFFFFEE6
        nop                                             ; 240B _ 90
        nop                                             ; 240C _ 90
        leave                                           ; 240D _ C9
        ret                                             ; 240E _ C3
...
?_143:  mov     eax, dword [ebp+8H]                     ; 25A2 _ 8B. 45, 08
        ...
        jle     ?_133                                   ; 25AB _ 0F 8E, FFFFFEBA
        nop                                             ; 25B1 _ 90
        leave                                           ; 25B2 _ C9
        ret                                             ; 25B3 _ C3
...
?_152:  cmp     dword [ebp-0CH], 499                    ; 2762 _ 81. 7D, F4, 000001F3
        jle     ?_150                                   ; 2769 _ 0F 8E, FFFFFF75
        nop                                             ; 276F _ 90
        leave                                           ; 2770 _ C9
        ret                                             ; 2771 _ C3
