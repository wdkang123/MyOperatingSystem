...
?_002:  sub     esp, 12                                 ; 027B _ 83. EC, 0C
        ...
        jle     ?_001                                   ; 02EF _ 0F 8E, FFFFFF52
...
?_026:  cmp     dword [ebp-4H], 15                      ; 09C3 _ 83. 7D, FC, 0F
        jle     ?_017                                   ; 09C7 _ 0F 8E, FFFFFE94
        nop                                             ; 09CD _ 90
        nop                                             ; 09CE _ 90
        leave                                           ; 09CF _ C9
        ret                                             ; 09D0 _ C3
...
?_045:  cmp     dword [ebp-8H], 1                       ; 0C61 _ 83. 7D, F8, 01
        jle     ?_046                                   ; 0C65 _ 7E, 06
        cmp     dword [ebp+8H], 0                       ; 0C67 _ 83. 7D, 08, 00
        jnz     ?_042                                   ; 0C6B _ 75, B3
...
mouse_decode:; Function begin
        ...
        jnz     ?_056                                   ; 0EA7 _ 75, 17
        cmp     byte [ebp-4H], -6                       ; 0EA9 _ 80. 7D, FC, FA
        jnz     ?_055                                   ; 0EAD _ 75, 07
...
?_059:  mov     eax, dword [ebp+8H]                     ; 0F15 _ 8B. 45, 08
        ...
        jne     ?_062                                   ; 0F1D _ 0F 85, 0000009C
...
?_082:  cmp     dword [ebp-8H], 0                       ; 1663 _ 83. 7D, F8, 00
        jle     ?_084                                   ; 1667 _ 0F 8E, 000000BA
        ...
        jne     ?_084                                   ; 1691 _ 0F 85, 00000090
...
?_100:  mov     eax, dword [ebp+0CH]                    ; 19F2 _ 8B. 45, 0C
        ...
        jle     ?_108                                   ; 1A01 _ 0F 8E, 000000F5
...
?_108:  mov     eax, dword [ebp-10H]                    ; 1AFC _ 8B. 45, F0
        ...
        jge     ?_115                                   ; 1B02 _ 0F 8D, 000000F8
...
?_128:  mov     eax, dword [ebp+8H]                     ; 1E23 _ 8B. 45, 08
        ...
        jle     ?_122                                   ; 1E2C _ 0F 8E, FFFFFF1A
        nop                                             ; 1E32 _ 90
        nop                                             ; 1E33 _ 90
        leave                                           ; 1E34 _ C9
        ret                                             ; 1E35 _ C3
