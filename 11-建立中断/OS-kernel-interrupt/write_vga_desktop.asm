...
CMain:  ; Function begin
        ...
        mov     eax, dword [?_032]                      ; 001F _ A1, 00000104(d)
        cwde                                            ; 0024 _ 98
        mov     dword [ebp-10H], eax                    ; 0025 _ 89. 45, F0
        mov     ax, word [?_033]                        ; 0028 _ 66: A1, 00000106(d)
        cwde                                            ; 002E _ 98
...
init_palette:; Function begin
        ...
        push    table_rgb.1585                          ; 0327 _ 68, 00000020(d)
...
?_021:  mov     eax, dword [ebp-8H]                     ; 05DD _ 8B. 45, F8
        ...
        add     eax, cursor.1632                        ; 05EA _ 05, 00000060(d)
...
?_022:  mov     eax, dword [ebp-8H]                     ; 060C _ 8B. 45, F8
        ...
        add     eax, cursor.1632                        ; 0619 _ 05, 00000060(d)
...
?_023:  mov     eax, dword [ebp-8H]                     ; 063B _ 8B. 45, F8
        ...
        add     eax, cursor.1632                        ; 0648 _ 05, 00000060(d)
...
intHandlerFromC:; Function begin
        ...
        sub     esp, 24                                 ; 06FA _ 83. EC, 18
        mov     eax, dword [bootInfo]                   ; 06FD _ A1, 00000100(d)
        mov     dword [ebp-0CH], eax                    ; 0702 _ 89. 45, F4
        mov     eax, dword [?_032]                      ; 0705 _ A1, 00000104(d)
        cwde                                            ; 070A _ 98
        mov     dword [ebp-10H], eax                    ; 070B _ 89. 45, F0
        mov     ax, word [?_033]                        ; 070E _ 66: A1, 00000106(d)
        cwde                                            ; 0714 _ 98
        mov     dword [ebp-14H], eax                    ; 0715 _ 89. 45, EC
        push    15                                      ; 0718 _ 6A, 0F
        push    255                                     ; 071A _ 68, 000000FF
        push    0                                       ; 071F _ 6A, 00
        push    0                                       ; 0721 _ 6A, 00
        push    0                                       ; 0723 _ 6A, 00
        push    dword [ebp-10H]                         ; 0725 _ FF. 75, F0
        push    dword [ebp-0CH]                         ; 0728 _ FF. 75, F4
        call    boxfill8                                ; 072B _ E8, FFFFFFFC(rel)
        add     esp, 28                                 ; 0730 _ 83. C4, 1C
        sub     esp, 8                                  ; 0733 _ 83. EC, 08
        push    ?_034                                   ; 0736 _ 68, 00000000(d)
        push    7                                       ; 073B _ 6A, 07
        push    0                                       ; 073D _ 6A, 00
        push    0                                       ; 073F _ 6A, 00
        push    dword [ebp-10H]                         ; 0741 _ FF. 75, F0
        push    dword [ebp-0CH]                         ; 0744 _ FF. 75, F4
        call    showString                              ; 0747 _ E8, FFFFFFFC(rel)
        add     esp, 32                                 ; 074C _ 83. C4, 20
?_031:  call    io_hlt                                  ; 074F _ E8, FFFFFFFC(rel)
        jmp     ?_031                                   ; 0754 _ EB, F9
...
?_034:                                                  ; byte
        db 50H, 53H, 2FH, 32H, 20H, 6BH, 65H, 79H       ; 0000 _ PS/2 key
        db 62H, 6FH, 61H, 72H, 64H, 00H                 ; 0008 _ board.
