...
?_008:  sub     esp, 12                                 ; 0712 _ 83. EC, 0C
        ...
        je near       ?_010                                   ; 0724 _ 0f 84, 0000017f
        ...
        jle near      ?_007                                   ; 0792 _ 0f 8e, ffffff34
...
?_009:  mov     eax, dword [ebp-40H]                    ; 07A4 _ 8B. 45, C0
        ...
        je near       ?_007                                   ; 07b0 _ 0f 84, ffffff16
        cmp     dword [ebp-0CH], 143                    ; 07B6 _ 81. 7D, F4, 0000008F
        jg  near      ?_007                                   ; 07bd _ 0f 8f, ffffff09
...
?_011:  sub     esp, 12                                 ; 08E1 _ 83. EC, 0C
        ...
        je near       ?_007                                   ; 08f3 _ 0f 84, fffffdd3
...
?_012:  cmp     dword [ebp-48H], 2                      ; 0947 _ 83. 7D, B8, 02
        je near       ?_007                                   ; 094b _ 0f 84, fffffd7b
        cmp     dword [ebp-48H], 0                      ; 0951 _ 83. 7D, B8, 00
        jz near       ?_013                                   ; 0955 _ 74, 1e
...
?_039:  cmp     dword [ebp-4H], 15                      ; 1185 _ 83. 7D, FC, 0F
        jle near      ?_030                                   ; 1189 _ 0f 8e, fffffe94
        nop                                             ; 118F _ 90
        nop                                             ; 1190 _ 90
        leave                                           ; 1191 _ C9
        ret                                             ; 1192 _ C3
...
?_058:  cmp     dword [ebp-8H], 1                       ; 1423 _ 83. 7D, F8, 01
        jle near      ?_059                                   ; 1427 _ 7e, 06
        cmp     dword [ebp+8H], 0                       ; 1429 _ 83. 7D, 08, 00
        jnz near      ?_055                                   ; 142d _ 75, b3
...
mouse_decode:; Function begin
        ...
        jnz near      ?_063                                   ; 1528 _ 75, 17
        cmp     byte [ebp-4H], -6                       ; 152A _ 80. 7D, FC, FA
        jnz near      ?_062                                   ; 152e _ 75, 07
...
?_066:  mov     eax, dword [ebp+8H]                     ; 1596 _ 8B. 45, 08
        ...
        jne near      ?_069                                   ; 159e _ 0f 85, 0000009c
...
?_084:  mov     eax, dword [ebp+8H]                     ; 1E6A _ 8B. 45, 08
        ...
        jc near       ?_081                                   ; 1e72 _ 0f 82, ffffff6e
...
?_089:  cmp     dword [ebp-8H], 0                       ; 1EB0 _ 83. 7D, F8, 00
        jle near      ?_091                                   ; 1eb4 _ 0f 8e, 000000ba
        ...
        jne near      ?_091                                   ; 1ede _ 0f 85, 00000090
...
?_092:  mov     eax, dword [ebp+8H]                     ; 1FD0 _ 8B. 45, 08
        ...
        jg  near      ?_096                                   ; 1fda _ 0f 8f, 00000086
...
?_108:  mov     eax, dword [ebp+0CH]                    ; 228D _ 8B. 45, 0C
        ...
        jle near      ?_115                                   ; 229c _ 0f 8e, 000001d3
        cmp     dword [ebp+10H], 0                      ; 22A2 _ 83. 7D, 10, 00
        js near       ?_111                                   ; 22a6 _ 0f 88, 000000e1
...
?_115:  mov     eax, dword [ebp-10H]                    ; 2475 _ 8B. 45, F0
        ...
        jge near      ?_122                                   ; 247b _ 0f 8d, 00000145
        cmp     dword [ebp-10H], 0                      ; 2481 _ 83. 7D, F0, 00
        js near       ?_118                                   ; 2485 _ 78, 55
...
sheet_slide:; Function begin
        ...
        js near       ?_124                                   ; 2674 _ 0f 88, 000000d3
...
?_135:  mov     eax, dword [ebp-4H]                     ; 28C7 _ 8B. 45, FC
        ...
        jle near      ?_129                                   ; 28cd _ 0f 8e, fffffee6
        nop                                             ; 28D3 _ 90
        nop                                             ; 28D4 _ 90
        leave                                           ; 28D5 _ C9
        ret                                             ; 28D6 _ C3
...
?_150:  mov     eax, dword [ebp+8H]                     ; 2A6A _ 8B. 45, 08
        ...
        jle near      ?_140                                   ; 2a73 _ 0f 8e, fffffeba
        nop                                             ; 2A79 _ 90
        leave                                           ; 2A7A _ C9
        ret                                             ; 2A7B _ C3
...
?_159:  cmp     dword [ebp-0CH], 499                    ; 2C2A _ 81. 7D, F4, 000001F3
        jle near      ?_157                                   ; 2c31 _ 0f 8e, ffffff75
        nop                                             ; 2C37 _ 90
        leave                                           ; 2C38 _ C9
        ret                                             ; 2C39 _ C3
