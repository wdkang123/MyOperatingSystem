...
?_002:  sub     esp, 12                                 ; 0268 _ 83. EC, 0C
        ...
        jle     ?_001                                   ; 02DC _ 0F 8E, FFFFFF52
...
?_026:  cmp     dword [ebp-4H], 15                      ; 09B8 _ 83. 7D, FC, 0F
        jle     ?_017                                   ; 09BC _ 0F 8E, FFFFFE94
        nop                                             ; 09C2 _ 90
        nop                                             ; 09C3 _ 90
        leave                                           ; 09C4 _ C9
        ret                                             ; 09C5 _ C3
...
?_045:  cmp     dword [ebp-8H], 1                       ; 0C56 _ 83. 7D, F8, 01
        jle     ?_046                                   ; 0C5A _ 7E, 06
        cmp     dword [ebp+8H], 0                       ; 0C5C _ 83. 7D, 08, 00
        jnz     ?_042                                   ; 0C60 _ 75, B3
...
mouse_decode:; Function begin
        ...
        jnz     ?_056                                   ; 0E9C _ 75, 17
        cmp     byte [ebp-4H], -6                       ; 0E9E _ 80. 7D, FC, FA
        jnz     ?_055                                   ; 0EA2 _ 75, 07
...
?_059:  mov     eax, dword [ebp+8H]                     ; 0F0A _ 8B. 45, 08
        ...
        jne     ?_062                                   ; 0F12 _ 0F 85, 0000009C
...
?_074:  cmp     dword [ebp-8H], 0                       ; 1362 _ 83. 7D, F8, 00
        jle     ?_076                                   ; 1366 _ 0F 8E, 000000BA
        ...
        jne     ?_076                                   ; 1390 _ 0F 85, 00000090
...
?_092:  mov     eax, dword [ebp+0CH]                    ; 16F1 _ 8B. 45, 0C
        ...
        jle     ?_100                                   ; 1700 _ 0F 8E, 000000F5
...
?_100:  mov     eax, dword [ebp-10H]                    ; 17FB _ 8B. 45, F0
        ...
        jge     ?_107                                   ; 1801 _ 0F 8D, 000000F8
...
?_116:  mov     eax, dword [ebp+8H]                     ; 1AE0 _ 8B. 45, 08
        ...
        jle     ?_110                                   ; 1AE9 _ 0F 8E, FFFFFF1A
        nop                                             ; 1AEF _ 90
        nop                                             ; 1AF0 _ 90
        leave                                           ; 1AF1 _ C9
        ret                                             ; 1AF2 _ C3
