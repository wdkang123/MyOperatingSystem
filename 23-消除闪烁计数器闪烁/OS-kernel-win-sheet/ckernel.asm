...
CMain:  ; Function begin
        ...
        mov     eax, dword [?_140]                      ; 001F _ A1, 00000004(d)
        cwde                                            ; 0024 _ 98
        mov     dword [xsize], eax                      ; 0025 _ A3, 000000F8(d)
        mov     ax, word [?_141]                        ; 002A _ 66: A1, 00000006(d)
        cwde                                            ; 0030 _ 98
        ...
        push    ?_128                                   ; 01EE _ 68, 00000000(d)
...
?_007:  sub     esp, 8                                  ; 065E _ 83. EC, 08
        push    ?_129                                   ; 0661 _ 68, 00000008(d)
        push    7                                       ; 0666 _ 6A, 07
        push    0                                       ; 0668 _ 6A, 00
        push    0                                       ; 066A _ 6A, 00
...
init_palette:; Function begin
        ...
        push    table_rgb.1776                          ; 079F _ 68, 00000020(d)
...
?_028:  mov     eax, dword [ebp-8H]                     ; 0A55 _ 8B. 45, F8
        ...
        add     eax, cursor.1823                        ; 0A62 _ 05, 00000060(d)
...
?_029:  mov     eax, dword [ebp-8H]                     ; 0A84 _ 8B. 45, F8
        ...
        add     eax, cursor.1823                        ; 0A91 _ 05, 00000060(d)
...
?_030:  mov     eax, dword [ebp-8H]                     ; 0AB3 _ 8B. 45, F8
        ...
        add     eax, cursor.1823                        ; 0AC0 _ 05, 00000060(d)
...
intHandlerFromC:; Function begin
        ...
        mov     eax, dword [?_140]                      ; 0B7D _ A1, 00000004(d)
        cwde                                            ; 0B82 _ 98
        mov     dword [ebp-10H], eax                    ; 0B83 _ 89. 45, F0
        mov     ax, word [?_141]                        ; 0B86 _ 66: A1, 00000006(d)
        cwde                                            ; 0B8C _ 98
...
charToHexStr:; Function begin
        ...
        mov     byte [?_139], al                        ; 0C16 _ A2, 00000007(d)
        ...
        mov     byte [?_138], al                        ; 0C33 _ A2, 00000006(d)
...
intToHexStr:; Function begin
        ...
        mov     byte [str.1871], 48                     ; 0C45 _ C6. 05, 00000220(d), 30
        mov     byte [?_142], 88                        ; 0C4C _ C6. 05, 00000221(d), 58
        mov     byte [?_143], 0                         ; 0C53 _ C6. 05, 0000022A(d), 00
        mov     dword [ebp-4H], 2                       ; 0C5A _ C7. 45, FC, 00000002
        jmp     ?_041                                   ; 0C61 _ EB, 0E

?_040:  mov     eax, dword [ebp-4H]                     ; 0C63 _ 8B. 45, FC
        add     eax, str.1871                           ; 0C66 _ 05, 00000220(d)
...
?_042:  mov     eax, dword [ebp+8H]                     ; 0C80 _ 8B. 45, 08
        ...
        add     eax, str.1871                           ; 0CA3 _ 05, 00000220(d)
...
?_043:  mov     eax, dword [ebp-0CH]                    ; 0CAC _ 8B. 45, F4
        ...
        add     eax, str.1871                           ; 0CB7 _ 05, 00000220(d)
...
?_046:  mov     eax, str.1871                           ; 0CCD _ B8, 00000220(d)
        leave                                           ; 0CD2 _ C9
        ret                                             ; 0CD3 _ C3
...
showMemoryInfo:; Function begin
        ...
        push    ?_130                                   ; 106C _ 68, 0000001F(d)
        push    eax                                     ; 1071 _ 50
        ...
        push    ?_131                                   ; 10C6 _ 68, 00000029(d)
        push    eax                                     ; 10CB _ 50
        ...
        push    ?_132                                   ; 1122 _ 68, 00000035(d)
        push    eax                                     ; 1127 _ 50
        ...
        push    ?_133                                   ; 117F _ 68, 00000041(d)
        push    eax                                     ; 1184 _ 50
        ...
        push    ?_134                                   ; 11DC _ 68, 0000004D(d)
        push    eax                                     ; 11E1 _ 50
        ...
        push    ?_135                                   ; 1239 _ 68, 0000005A(d)
        push    eax                                     ; 123E _ 50
...
message_box:; Function begin
        ...
        push    ?_136                                   ; 12ED _ 68, 00000061(d)
        push    0                                       ; 12F2 _ 6A, 00
        ...
        push    ?_137                                   ; 1309 _ 68, 0000006C(d)
        push    0                                       ; 130E _ 6A, 00
...
?_065:  mov     eax, dword [ebp-10H]                    ; 14FE _ 8B. 45, F0
        ...
        add     eax, closebtn.1951                      ; 150B _ 05, 00000160(d)
...
sheet_updown:; Function begin
        ...
        push    esi                                     ; 1A24 _ 56
        push    ebx                                     ; 1A25 _ 53
        sub     esp, 16                                 ; 1A26 _ 83. EC, 10
        mov     eax, dword [ebp+0CH]                    ; 1A29 _ 8B. 45, 0C
        mov     eax, dword [eax+18H]                    ; 1A2C _ 8B. 40, 18
        mov     dword [ebp-10H], eax                    ; 1A2F _ 89. 45, F0
        mov     eax, dword [ebp+8H]                     ; 1A32 _ 8B. 45, 08
        mov     eax, dword [eax+0CH]                    ; 1A35 _ 8B. 40, 0C
        inc     eax                                     ; 1A38 _ 40
        cmp     dword [ebp+10H], eax                    ; 1A39 _ 39. 45, 10
        jle near      ?_099                                   ; 1a3c _ 7e, 0a
        mov     eax, dword [ebp+8H]                     ; 1A3E _ 8B. 45, 08
        mov     eax, dword [eax+0CH]                    ; 1A41 _ 8B. 40, 0C
        inc     eax                                     ; 1A44 _ 40
        mov     dword [ebp+10H], eax                    ; 1A45 _ 89. 45, 10
?_099:  cmp     dword [ebp+10H], -1                     ; 1A48 _ 83. 7D, 10, FF
        jge near      ?_100                                   ; 1a4c _ 7d, 07
        mov     dword [ebp+10H], -1                     ; 1A4E _ C7. 45, 10, FFFFFFFF
?_100:  mov     eax, dword [ebp+0CH]                    ; 1A55 _ 8B. 45, 0C
        mov     edx, dword [ebp+10H]                    ; 1A58 _ 8B. 55, 10
        mov     dword [eax+18H], edx                    ; 1A5B _ 89. 50, 18
        mov     eax, dword [ebp-10H]                    ; 1A5E _ 8B. 45, F0
        cmp     eax, dword [ebp+10H]                    ; 1A61 _ 3B. 45, 10
        jle near      ?_107                                   ; 1a64 _ 0f 8e, 00000141
        cmp     dword [ebp+10H], 0                      ; 1A6A _ 83. 7D, 10, 00
        js near       ?_103                                   ; 1a6e _ 0f 88, 00000097
        mov     eax, dword [ebp-10H]                    ; 1A74 _ 8B. 45, F0
        mov     dword [ebp-0CH], eax                    ; 1A77 _ 89. 45, F4
        jmp     ?_102                                   ; 1A7A _ EB, 30

?_101:  mov     eax, dword [ebp-0CH]                    ; 1A7C _ 8B. 45, F4
        lea     edx, [eax-1H]                           ; 1A7F _ 8D. 50, FF
        ...
        mov     ecx, dword [ebp-0CH]                    ; 1A8E _ 8B. 4D, F4
        add     ecx, 4                                  ; 1A91 _ 83. C1, 04
        mov     dword [eax+ecx*4], edx                  ; 1A94 _ 89. 14 88
        mov     eax, dword [ebp+8H]                     ; 1A97 _ 8B. 45, 08
        mov     edx, dword [ebp-0CH]                    ; 1A9A _ 8B. 55, F4
        add     edx, 4                                  ; 1A9D _ 83. C2, 04
        mov     eax, dword [eax+edx*4]                  ; 1AA0 _ 8B. 04 90
        mov     edx, dword [ebp-0CH]                    ; 1AA3 _ 8B. 55, F4
        mov     dword [eax+18H], edx                    ; 1AA6 _ 89. 50, 18
        dec     dword [ebp-0CH]                         ; 1AA9 _ FF. 4D, F4
?_102:  mov     eax, dword [ebp-0CH]                    ; 1AAC _ 8B. 45, F4
        cmp     eax, dword [ebp+10H]                    ; 1AAF _ 3B. 45, 10
        jg  near      ?_101                                   ; 1ab2 _ 7f, c8
        mov     eax, dword [ebp+8H]                     ; 1AB4 _ 8B. 45, 08
        mov     edx, dword [ebp+10H]                    ; 1AB7 _ 8B. 55, 10
        lea     ecx, [edx+4H]                           ; 1ABA _ 8D. 4A, 04
        mov     edx, dword [ebp+0CH]                    ; 1ABD _ 8B. 55, 0C
        mov     dword [eax+ecx*4], edx                  ; 1AC0 _ 89. 14 88
        mov     eax, dword [ebp+10H]                    ; 1AC3 _ 8B. 45, 10
        lea     esi, [eax+1H]                           ; 1AC6 _ 8D. 70, 01
        mov     eax, dword [ebp+0CH]                    ; 1AC9 _ 8B. 45, 0C
        mov     edx, dword [eax+10H]                    ; 1ACC _ 8B. 50, 10
        mov     eax, dword [ebp+0CH]                    ; 1ACF _ 8B. 45, 0C
        mov     eax, dword [eax+8H]                     ; 1AD2 _ 8B. 40, 08
        lea     ebx, [edx+eax]                          ; 1AD5 _ 8D. 1C 02
        mov     eax, dword [ebp+0CH]                    ; 1AD8 _ 8B. 45, 0C
        mov     edx, dword [eax+0CH]                    ; 1ADB _ 8B. 50, 0C
        mov     eax, dword [ebp+0CH]                    ; 1ADE _ 8B. 45, 0C
        mov     eax, dword [eax+4H]                     ; 1AE1 _ 8B. 40, 04
        lea     ecx, [edx+eax]                          ; 1AE4 _ 8D. 0C 02
        mov     eax, dword [ebp+0CH]                    ; 1AE7 _ 8B. 45, 0C
        mov     edx, dword [eax+10H]                    ; 1AEA _ 8B. 50, 10
        mov     eax, dword [ebp+0CH]                    ; 1AED _ 8B. 45, 0C
        mov     eax, dword [eax+0CH]                    ; 1AF0 _ 8B. 40, 0C
        sub     esp, 8                                  ; 1AF3 _ 83. EC, 08
        push    esi                                     ; 1AF6 _ 56
        push    ebx                                     ; 1AF7 _ 53
        push    ecx                                     ; 1AF8 _ 51
        push    edx                                     ; 1AF9 _ 52
        push    eax                                     ; 1AFA _ 50
        push    dword [ebp+8H]                          ; 1AFB _ FF. 75, 08
        call    sheet_refreshsub                        ; 1AFE _ E8, FFFFFFFC(rel)
        add     esp, 32                                 ; 1B03 _ 83. C4, 20
        jmp     ?_114                                   ; 1B06 _ E9, 000001A7

?_103:  mov     eax, dword [ebp+8H]                     ; 1B0B _ 8B. 45, 08
        mov     eax, dword [eax+0CH]                    ; 1B0E _ 8B. 40, 0C
        cmp     dword [ebp-10H], eax                    ; 1B11 _ 39. 45, F0
        jge near      ?_106                                   ; 1b14 _ 7d, 43
        mov     eax, dword [ebp-10H]                    ; 1B16 _ 8B. 45, F0
        mov     dword [ebp-0CH], eax                    ; 1B19 _ 89. 45, F4
        jmp     ?_105                                   ; 1B1C _ EB, 30

?_104:  mov     eax, dword [ebp-0CH]                    ; 1B1E _ 8B. 45, F4
        lea     edx, [eax+1H]                           ; 1B21 _ 8D. 50, 01
        mov     eax, dword [ebp+8H]                     ; 1B24 _ 8B. 45, 08
        add     edx, 4                                  ; 1B27 _ 83. C2, 04
        mov     edx, dword [eax+edx*4]                  ; 1B2A _ 8B. 14 90
        mov     eax, dword [ebp+8H]                     ; 1B2D _ 8B. 45, 08
        mov     ecx, dword [ebp-0CH]                    ; 1B30 _ 8B. 4D, F4
        add     ecx, 4                                  ; 1B33 _ 83. C1, 04
        mov     dword [eax+ecx*4], edx                  ; 1B36 _ 89. 14 88
        mov     eax, dword [ebp+8H]                     ; 1B39 _ 8B. 45, 08
        mov     edx, dword [ebp-0CH]                    ; 1B3C _ 8B. 55, F4
        add     edx, 4                                  ; 1B3F _ 83. C2, 04
        mov     eax, dword [eax+edx*4]                  ; 1B42 _ 8B. 04 90
        mov     edx, dword [ebp-0CH]                    ; 1B45 _ 8B. 55, F4
        mov     dword [eax+18H], edx                    ; 1B48 _ 89. 50, 18
        inc     dword [ebp-0CH]                         ; 1B4B _ FF. 45, F4
?_105:  mov     eax, dword [ebp+8H]                     ; 1B4E _ 8B. 45, 08
        mov     eax, dword [eax+0CH]                    ; 1B51 _ 8B. 40, 0C
        cmp     dword [ebp-0CH], eax                    ; 1B54 _ 39. 45, F4
        jl      ?_104                                   ; 1B57 _ 7C, C5
?_106:  mov     eax, dword [ebp+8H]                     ; 1B59 _ 8B. 45, 08
        mov     eax, dword [eax+0CH]                    ; 1B5C _ 8B. 40, 0C
        lea     edx, [eax-1H]                           ; 1B5F _ 8D. 50, FF
        mov     eax, dword [ebp+8H]                     ; 1B62 _ 8B. 45, 08
        mov     dword [eax+0CH], edx                    ; 1B65 _ 89. 50, 0C
        mov     eax, dword [ebp+0CH]                    ; 1B68 _ 8B. 45, 0C
        mov     edx, dword [eax+10H]                    ; 1B6B _ 8B. 50, 10
        mov     eax, dword [ebp+0CH]                    ; 1B6E _ 8B. 45, 0C
        mov     eax, dword [eax+8H]                     ; 1B71 _ 8B. 40, 08
        lea     ebx, [edx+eax]                          ; 1B74 _ 8D. 1C 02
        mov     eax, dword [ebp+0CH]                    ; 1B77 _ 8B. 45, 0C
        mov     edx, dword [eax+0CH]                    ; 1B7A _ 8B. 50, 0C
        mov     eax, dword [ebp+0CH]                    ; 1B7D _ 8B. 45, 0C
        mov     eax, dword [eax+4H]                     ; 1B80 _ 8B. 40, 04
        lea     ecx, [edx+eax]                          ; 1B83 _ 8D. 0C 02
        mov     eax, dword [ebp+0CH]                    ; 1B86 _ 8B. 45, 0C
        mov     edx, dword [eax+10H]                    ; 1B89 _ 8B. 50, 10
        mov     eax, dword [ebp+0CH]                    ; 1B8C _ 8B. 45, 0C
        mov     eax, dword [eax+0CH]                    ; 1B8F _ 8B. 40, 0C
        sub     esp, 8                                  ; 1B92 _ 83. EC, 08
        push    0                                       ; 1B95 _ 6A, 00
        push    ebx                                     ; 1B97 _ 53
        push    ecx                                     ; 1B98 _ 51
        push    edx                                     ; 1B99 _ 52
        push    eax                                     ; 1B9A _ 50
        push    dword [ebp+8H]                          ; 1B9B _ FF. 75, 08
        call    sheet_refreshsub                        ; 1B9E _ E8, FFFFFFFC(rel)
        add     esp, 32                                 ; 1BA3 _ 83. C4, 20
        jmp     ?_114                                   ; 1BA6 _ E9, 00000107

?_107:  mov     eax, dword [ebp-10H]                    ; 1BAB _ 8B. 45, F0
        cmp     eax, dword [ebp+10H]                    ; 1BAE _ 3B. 45, 10
        jge near      ?_114                                   ; 1bb1 _ 0f 8d, 000000fb
        cmp     dword [ebp-10H], 0                      ; 1BB7 _ 83. 7D, F0, 00
        js near       ?_110                                   ; 1bbb _ 78, 51
        mov     eax, dword [ebp-10H]                    ; 1BBD _ 8B. 45, F0
        mov     dword [ebp-0CH], eax                    ; 1BC0 _ 89. 45, F4
        jmp     ?_109                                   ; 1BC3 _ EB, 30

?_108:  mov     eax, dword [ebp-0CH]                    ; 1BC5 _ 8B. 45, F4
        lea     edx, [eax+1H]                           ; 1BC8 _ 8D. 50, 01
        mov     eax, dword [ebp+8H]                     ; 1BCB _ 8B. 45, 08
        add     edx, 4                                  ; 1BCE _ 83. C2, 04
        mov     edx, dword [eax+edx*4]                  ; 1BD1 _ 8B. 14 90
        mov     eax, dword [ebp+8H]                     ; 1BD4 _ 8B. 45, 08
        mov     ecx, dword [ebp-0CH]                    ; 1BD7 _ 8B. 4D, F4
        add     ecx, 4                                  ; 1BDA _ 83. C1, 04
        mov     dword [eax+ecx*4], edx                  ; 1BDD _ 89. 14 88
        mov     eax, dword [ebp+8H]                     ; 1BE0 _ 8B. 45, 08
        mov     edx, dword [ebp-0CH]                    ; 1BE3 _ 8B. 55, F4
        add     edx, 4                                  ; 1BE6 _ 83. C2, 04
        mov     eax, dword [eax+edx*4]                  ; 1BE9 _ 8B. 04 90
        mov     edx, dword [ebp-0CH]                    ; 1BEC _ 8B. 55, F4
        mov     dword [eax+18H], edx                    ; 1BEF _ 89. 50, 18
        inc     dword [ebp-0CH]                         ; 1BF2 _ FF. 45, F4
?_109:  mov     eax, dword [ebp-0CH]                    ; 1BF5 _ 8B. 45, F4
        cmp     eax, dword [ebp+10H]                    ; 1BF8 _ 3B. 45, 10
        jl      ?_108                                   ; 1BFB _ 7C, C8
        mov     eax, dword [ebp+8H]                     ; 1BFD _ 8B. 45, 08
        mov     edx, dword [ebp+10H]                    ; 1C00 _ 8B. 55, 10
        lea     ecx, [edx+4H]                           ; 1C03 _ 8D. 4A, 04
        mov     edx, dword [ebp+0CH]                    ; 1C06 _ 8B. 55, 0C
        mov     dword [eax+ecx*4], edx                  ; 1C09 _ 89. 14 88
        jmp     ?_113                                   ; 1C0C _ EB, 65

?_110:  mov     eax, dword [ebp+8H]                     ; 1C0E _ 8B. 45, 08
        mov     eax, dword [eax+0CH]                    ; 1C11 _ 8B. 40, 0C
        mov     dword [ebp-0CH], eax                    ; 1C14 _ 89. 45, F4
        jmp     ?_112                                   ; 1C17 _ EB, 34

?_111:  mov     eax, dword [ebp-0CH]                    ; 1C19 _ 8B. 45, F4
        lea     ecx, [eax+1H]                           ; 1C1C _ 8D. 48, 01
        mov     eax, dword [ebp+8H]                     ; 1C1F _ 8B. 45, 08
        mov     edx, dword [ebp-0CH]                    ; 1C22 _ 8B. 55, F4
        add     edx, 4                                  ; 1C25 _ 83. C2, 04
        mov     edx, dword [eax+edx*4]                  ; 1C28 _ 8B. 14 90
        mov     eax, dword [ebp+8H]                     ; 1C2B _ 8B. 45, 08
        add     ecx, 4                                  ; 1C2E _ 83. C1, 04
        mov     dword [eax+ecx*4], edx                  ; 1C31 _ 89. 14 88
        mov     eax, dword [ebp-0CH]                    ; 1C34 _ 8B. 45, F4
        lea     edx, [eax+1H]                           ; 1C37 _ 8D. 50, 01
        mov     eax, dword [ebp+8H]                     ; 1C3A _ 8B. 45, 08
        add     edx, 4                                  ; 1C3D _ 83. C2, 04
        mov     eax, dword [eax+edx*4]                  ; 1C40 _ 8B. 04 90
        mov     edx, dword [ebp-0CH]                    ; 1C43 _ 8B. 55, F4
        inc     edx                                     ; 1C46 _ 42
        mov     dword [eax+18H], edx                    ; 1C47 _ 89. 50, 18
        dec     dword [ebp-0CH]                         ; 1C4A _ FF. 4D, F4
?_112:  mov     eax, dword [ebp-0CH]                    ; 1C4D _ 8B. 45, F4
        cmp     eax, dword [ebp+10H]                    ; 1C50 _ 3B. 45, 10
        jge near      ?_111                                   ; 1c53 _ 7d, c4
        mov     eax, dword [ebp+8H]                     ; 1C55 _ 8B. 45, 08
        mov     edx, dword [ebp+10H]                    ; 1C58 _ 8B. 55, 10
        lea     ecx, [edx+4H]                           ; 1C5B _ 8D. 4A, 04
        mov     edx, dword [ebp+0CH]                    ; 1C5E _ 8B. 55, 0C
        mov     dword [eax+ecx*4], edx                  ; 1C61 _ 89. 14 88
        mov     eax, dword [ebp+8H]                     ; 1C64 _ 8B. 45, 08
        mov     eax, dword [eax+0CH]                    ; 1C67 _ 8B. 40, 0C
        lea     edx, [eax+1H]                           ; 1C6A _ 8D. 50, 01
        mov     eax, dword [ebp+8H]                     ; 1C6D _ 8B. 45, 08
        mov     dword [eax+0CH], edx                    ; 1C70 _ 89. 50, 0C
?_113:  mov     eax, dword [ebp+0CH]                    ; 1C73 _ 8B. 45, 0C
        mov     edx, dword [eax+10H]                    ; 1C76 _ 8B. 50, 10
        mov     eax, dword [ebp+0CH]                    ; 1C79 _ 8B. 45, 0C
        mov     eax, dword [eax+8H]                     ; 1C7C _ 8B. 40, 08
        lea     ebx, [edx+eax]                          ; 1C7F _ 8D. 1C 02
        mov     eax, dword [ebp+0CH]                    ; 1C82 _ 8B. 45, 0C
        mov     edx, dword [eax+0CH]                    ; 1C85 _ 8B. 50, 0C
        mov     eax, dword [ebp+0CH]                    ; 1C88 _ 8B. 45, 0C
        mov     eax, dword [eax+4H]                     ; 1C8B _ 8B. 40, 04
        lea     ecx, [edx+eax]                          ; 1C8E _ 8D. 0C 02
        mov     eax, dword [ebp+0CH]                    ; 1C91 _ 8B. 45, 0C
        mov     edx, dword [eax+10H]                    ; 1C94 _ 8B. 50, 10
        mov     eax, dword [ebp+0CH]                    ; 1C97 _ 8B. 45, 0C
        mov     eax, dword [eax+0CH]                    ; 1C9A _ 8B. 40, 0C
        sub     esp, 8                                  ; 1C9D _ 83. EC, 08
        push    dword [ebp+10H]                         ; 1CA0 _ FF. 75, 10
        push    ebx                                     ; 1CA3 _ 53
        push    ecx                                     ; 1CA4 _ 51
        push    edx                                     ; 1CA5 _ 52
        push    eax                                     ; 1CA6 _ 50
        push    dword [ebp+8H]                          ; 1CA7 _ FF. 75, 08
        call    sheet_refreshsub                        ; 1CAA _ E8, FFFFFFFC(rel)
        add     esp, 32                                 ; 1CAF _ 83. C4, 20
?_114:  nop                                             ; 1CB2 _ 90
        lea     esp, [ebp-8H]                           ; 1CB3 _ 8D. 65, F8
        pop     ebx                                     ; 1CB6 _ 5B
        pop     esi                                     ; 1CB7 _ 5E
        pop     ebp                                     ; 1CB8 _ 5D
        ret                                             ; 1CB9 _ C3
...
sheet_refresh:; Function begin
        ...
        push    esi                                     ; 1CBE _ 56
        push    ebx                                     ; 1CBF _ 53
        sub     esp, 12                                 ; 1CC0 _ 83. EC, 0C
        mov     eax, dword [ebp+0CH]                    ; 1CC3 _ 8B. 45, 0C
        mov     eax, dword [eax+18H]                    ; 1CC6 _ 8B. 40, 18
        test    eax, eax                                ; 1CC9 _ 85. C0
        js near       ?_115                                   ; 1ccb _ 78, 47
        mov     eax, dword [ebp+0CH]                    ; 1CCD _ 8B. 45, 0C
        mov     eax, dword [eax+18H]                    ; 1CD0 _ 8B. 40, 18
        mov     edx, dword [ebp+0CH]                    ; 1CD3 _ 8B. 55, 0C
        mov     ecx, dword [edx+10H]                    ; 1CD6 _ 8B. 4A, 10
        mov     edx, dword [ebp+1CH]                    ; 1CD9 _ 8B. 55, 1C
        lea     esi, [ecx+edx]                          ; 1CDC _ 8D. 34 11
        mov     edx, dword [ebp+0CH]                    ; 1CDF _ 8B. 55, 0C
        mov     ecx, dword [edx+0CH]                    ; 1CE2 _ 8B. 4A, 0C
        mov     edx, dword [ebp+18H]                    ; 1CE5 _ 8B. 55, 18
        lea     ebx, [ecx+edx]                          ; 1CE8 _ 8D. 1C 11
        mov     edx, dword [ebp+0CH]                    ; 1CEB _ 8B. 55, 0C
        mov     ecx, dword [edx+10H]                    ; 1CEE _ 8B. 4A, 10
        mov     edx, dword [ebp+14H]                    ; 1CF1 _ 8B. 55, 14
        add     ecx, edx                                ; 1CF4 _ 01. D1
        mov     edx, dword [ebp+0CH]                    ; 1CF6 _ 8B. 55, 0C
        mov     edi, dword [edx+0CH]                    ; 1CF9 _ 8B. 7A, 0C
        mov     edx, dword [ebp+10H]                    ; 1CFC _ 8B. 55, 10
        add     edx, edi                                ; 1CFF _ 01. FA
        sub     esp, 8                                  ; 1D01 _ 83. EC, 08
        push    eax                                     ; 1D04 _ 50
        push    esi                                     ; 1D05 _ 56
        push    ebx                                     ; 1D06 _ 53
        push    ecx                                     ; 1D07 _ 51
        push    edx                                     ; 1D08 _ 52
        push    dword [ebp+8H]                          ; 1D09 _ FF. 75, 08
        call    sheet_refreshsub                        ; 1D0C _ E8, FFFFFFFC(rel)
        add     esp, 32                                 ; 1D11 _ 83. C4, 20
?_115:  mov     eax, 0                                  ; 1D14 _ B8, 00000000
        lea     esp, [ebp-0CH]                          ; 1D19 _ 8D. 65, F4
        pop     ebx                                     ; 1D1C _ 5B
        pop     esi                                     ; 1D1D _ 5E
        pop     edi                                     ; 1D1E _ 5F
        pop     ebp                                     ; 1D1F _ 5D
...
sheet_slide:; Function begin
        ...
        push    ebx                                     ; 1D24 _ 53
        sub     esp, 20                                 ; 1D25 _ 83. EC, 14
        mov     eax, dword [ebp+0CH]                    ; 1D28 _ 8B. 45, 0C
        mov     eax, dword [eax+0CH]                    ; 1D2B _ 8B. 40, 0C
        mov     dword [ebp-0CH], eax                    ; 1D2E _ 89. 45, F4
        mov     eax, dword [ebp+0CH]                    ; 1D31 _ 8B. 45, 0C
        mov     eax, dword [eax+10H]                    ; 1D34 _ 8B. 40, 10
        mov     dword [ebp-10H], eax                    ; 1D37 _ 89. 45, F0
        mov     eax, dword [ebp+0CH]                    ; 1D3A _ 8B. 45, 0C
        mov     edx, dword [ebp+10H]                    ; 1D3D _ 8B. 55, 10
        mov     dword [eax+0CH], edx                    ; 1D40 _ 89. 50, 0C
        mov     eax, dword [ebp+0CH]                    ; 1D43 _ 8B. 45, 0C
        mov     edx, dword [ebp+14H]                    ; 1D46 _ 8B. 55, 14
        mov     dword [eax+10H], edx                    ; 1D49 _ 89. 50, 10
        mov     eax, dword [ebp+0CH]                    ; 1D4C _ 8B. 45, 0C
        mov     eax, dword [eax+18H]                    ; 1D4F _ 8B. 40, 18
        test    eax, eax                                ; 1D52 _ 85. C0
        js near       ?_116                                   ; 1d54 _ 78, 61
        mov     eax, dword [ebp+0CH]                    ; 1D56 _ 8B. 45, 0C
        mov     edx, dword [eax+8H]                     ; 1D59 _ 8B. 50, 08
        mov     eax, dword [ebp-10H]                    ; 1D5C _ 8B. 45, F0
        add     edx, eax                                ; 1D5F _ 01. C2
        mov     eax, dword [ebp+0CH]                    ; 1D61 _ 8B. 45, 0C
        mov     ecx, dword [eax+4H]                     ; 1D64 _ 8B. 48, 04
        mov     eax, dword [ebp-0CH]                    ; 1D67 _ 8B. 45, F4
        add     eax, ecx                                ; 1D6A _ 01. C8
        sub     esp, 8                                  ; 1D6C _ 83. EC, 08
        push    0                                       ; 1D6F _ 6A, 00
        push    edx                                     ; 1D71 _ 52
        push    eax                                     ; 1D72 _ 50
        push    dword [ebp-10H]                         ; 1D73 _ FF. 75, F0
        push    dword [ebp-0CH]                         ; 1D76 _ FF. 75, F4
        push    dword [ebp+8H]                          ; 1D79 _ FF. 75, 08
        call    sheet_refreshsub                        ; 1D7C _ E8, FFFFFFFC(rel)
        add     esp, 32                                 ; 1D81 _ 83. C4, 20
        mov     eax, dword [ebp+0CH]                    ; 1D84 _ 8B. 45, 0C
        mov     eax, dword [eax+18H]                    ; 1D87 _ 8B. 40, 18
        mov     edx, dword [ebp+0CH]                    ; 1D8A _ 8B. 55, 0C
        mov     ecx, dword [edx+8H]                     ; 1D8D _ 8B. 4A, 08
        mov     edx, dword [ebp+14H]                    ; 1D90 _ 8B. 55, 14
        add     ecx, edx                                ; 1D93 _ 01. D1
        mov     edx, dword [ebp+0CH]                    ; 1D95 _ 8B. 55, 0C
        mov     ebx, dword [edx+4H]                     ; 1D98 _ 8B. 5A, 04
        mov     edx, dword [ebp+10H]                    ; 1D9B _ 8B. 55, 10
        add     edx, ebx                                ; 1D9E _ 01. DA
        sub     esp, 8                                  ; 1DA0 _ 83. EC, 08
        push    eax                                     ; 1DA3 _ 50
        push    ecx                                     ; 1DA4 _ 51
        push    edx                                     ; 1DA5 _ 52
        push    dword [ebp+14H]                         ; 1DA6 _ FF. 75, 14
        push    dword [ebp+10H]                         ; 1DA9 _ FF. 75, 10
        push    dword [ebp+8H]                          ; 1DAC _ FF. 75, 08
        call    sheet_refreshsub                        ; 1DAF _ E8, FFFFFFFC(rel)
        add     esp, 32                                 ; 1DB4 _ 83. C4, 20
?_116:  nop                                             ; 1DB7 _ 90
        mov     ebx, dword [ebp-4H]                     ; 1DB8 _ 8B. 5D, FC
        leave                                           ; 1DBB _ C9
        ret                                             ; 1DBC _ C3
...
sheet_refreshsub:; Function begin
        ...
        sub     esp, 48                                 ; 1DC0 _ 83. EC, 30
        mov     eax, dword [ebp+8H]                     ; 1DC3 _ 8B. 45, 08
        mov     eax, dword [eax]                        ; 1DC6 _ 8B. 00
        mov     dword [ebp-10H], eax                    ; 1DC8 _ 89. 45, F0
        cmp     dword [ebp+0CH], 0                      ; 1DCB _ 83. 7D, 0C, 00
        jns     ?_117                                   ; 1DCF _ 79, 07
        mov     dword [ebp+0CH], 0                      ; 1DD1 _ C7. 45, 0C, 00000000
?_117:  cmp     dword [ebp+10H], 8                      ; 1DD8 _ 83. 7D, 10, 08
        jg  near      ?_118                                   ; 1ddc _ 7f, 07
        mov     dword [ebp+10H], 0                      ; 1DDE _ C7. 45, 10, 00000000
?_118:  mov     eax, dword [ebp+8H]                     ; 1DE5 _ 8B. 45, 08
        mov     eax, dword [eax+4H]                     ; 1DE8 _ 8B. 40, 04
        cmp     dword [ebp+14H], eax                    ; 1DEB _ 39. 45, 14
        jle near      ?_119                                   ; 1dee _ 7e, 09
        mov     eax, dword [ebp+8H]                     ; 1DF0 _ 8B. 45, 08
        mov     eax, dword [eax+4H]                     ; 1DF3 _ 8B. 40, 04
        mov     dword [ebp+14H], eax                    ; 1DF6 _ 89. 45, 14
?_119:  mov     eax, dword [ebp+8H]                     ; 1DF9 _ 8B. 45, 08
        mov     eax, dword [eax+8H]                     ; 1DFC _ 8B. 40, 08
        cmp     dword [ebp+18H], eax                    ; 1DFF _ 39. 45, 18
        jle near      ?_120                                   ; 1e02 _ 7e, 09
        mov     eax, dword [ebp+8H]                     ; 1E04 _ 8B. 45, 08
        mov     eax, dword [eax+8H]                     ; 1E07 _ 8B. 40, 08
        mov     dword [ebp+18H], eax                    ; 1E0A _ 89. 45, 18
?_120:  mov     eax, dword [ebp+1CH]                    ; 1E0D _ 8B. 45, 1C
        mov     dword [ebp-4H], eax                     ; 1E10 _ 89. 45, FC
        jmp     ?_127                                   ; 1E13 _ E9, 000000D7

?_121:  mov     eax, dword [ebp+8H]                     ; 1E18 _ 8B. 45, 08
        mov     edx, dword [ebp-4H]                     ; 1E1B _ 8B. 55, FC
        add     edx, 4                                  ; 1E1E _ 83. C2, 04
        mov     eax, dword [eax+edx*4]                  ; 1E21 _ 8B. 04 90
        mov     dword [ebp-14H], eax                    ; 1E24 _ 89. 45, EC
        mov     eax, dword [ebp-14H]                    ; 1E27 _ 8B. 45, EC
        mov     eax, dword [eax]                        ; 1E2A _ 8B. 00
        mov     dword [ebp-18H], eax                    ; 1E2C _ 89. 45, E8
        mov     dword [ebp-0CH], 0                      ; 1E2F _ C7. 45, F4, 00000000
        jmp     ?_126                                   ; 1E36 _ E9, 000000A2

?_122:  mov     eax, dword [ebp-14H]                    ; 1E3B _ 8B. 45, EC
        mov     edx, dword [eax+10H]                    ; 1E3E _ 8B. 50, 10
        mov     eax, dword [ebp-0CH]                    ; 1E41 _ 8B. 45, F4
        add     eax, edx                                ; 1E44 _ 01. D0
        mov     dword [ebp-1CH], eax                    ; 1E46 _ 89. 45, E4
        mov     dword [ebp-8H], 0                       ; 1E49 _ C7. 45, F8, 00000000
        jmp     ?_125                                   ; 1E50 _ EB, 79

?_123:  mov     eax, dword [ebp-14H]                    ; 1E52 _ 8B. 45, EC
        mov     edx, dword [eax+0CH]                    ; 1E55 _ 8B. 50, 0C
        mov     eax, dword [ebp-8H]                     ; 1E58 _ 8B. 45, F8
        add     eax, edx                                ; 1E5B _ 01. D0
        mov     dword [ebp-20H], eax                    ; 1E5D _ 89. 45, E0
        mov     eax, dword [ebp+0CH]                    ; 1E60 _ 8B. 45, 0C
        cmp     eax, dword [ebp-20H]                    ; 1E63 _ 3B. 45, E0
        jg  near      ?_124                                   ; 1e66 _ 7f, 60
        mov     eax, dword [ebp-20H]                    ; 1E68 _ 8B. 45, E0
        cmp     eax, dword [ebp+14H]                    ; 1E6B _ 3B. 45, 14
        jge near      ?_124                                   ; 1e6e _ 7d, 58
        mov     eax, dword [ebp+10H]                    ; 1E70 _ 8B. 45, 10
        cmp     eax, dword [ebp-1CH]                    ; 1E73 _ 3B. 45, E4
        jg  near      ?_124                                   ; 1e76 _ 7f, 50
        mov     eax, dword [ebp-1CH]                    ; 1E78 _ 8B. 45, E4
        cmp     eax, dword [ebp+18H]                    ; 1E7B _ 3B. 45, 18
        jge near      ?_124                                   ; 1e7e _ 7d, 48
        mov     eax, dword [ebp-14H]                    ; 1E80 _ 8B. 45, EC
        mov     eax, dword [eax+4H]                     ; 1E83 _ 8B. 40, 04
        imul    eax, dword [ebp-0CH]                    ; 1E86 _ 0F AF. 45, F4
        mov     edx, eax                                ; 1E8A _ 89. C2
        mov     eax, dword [ebp-8H]                     ; 1E8C _ 8B. 45, F8
        add     eax, edx                                ; 1E8F _ 01. D0
        mov     edx, eax                                ; 1E91 _ 89. C2
        mov     eax, dword [ebp-18H]                    ; 1E93 _ 8B. 45, E8
        add     eax, edx                                ; 1E96 _ 01. D0
        mov     al, byte [eax]                          ; 1E98 _ 8A. 00
        mov     byte [ebp-21H], al                      ; 1E9A _ 88. 45, DF
        movzx   edx, byte [ebp-21H]                     ; 1E9D _ 0F B6. 55, DF
        mov     eax, dword [ebp-14H]                    ; 1EA1 _ 8B. 45, EC
        mov     eax, dword [eax+14H]                    ; 1EA4 _ 8B. 40, 14
        cmp     edx, eax                                ; 1EA7 _ 39. C2
        jz near       ?_124                                   ; 1ea9 _ 74, 1d
        mov     eax, dword [ebp+8H]                     ; 1EAB _ 8B. 45, 08
        mov     eax, dword [eax+4H]                     ; 1EAE _ 8B. 40, 04
        imul    eax, dword [ebp-1CH]                    ; 1EB1 _ 0F AF. 45, E4
        mov     edx, eax                                ; 1EB5 _ 89. C2
        mov     eax, dword [ebp-20H]                    ; 1EB7 _ 8B. 45, E0
        add     eax, edx                                ; 1EBA _ 01. D0
        mov     edx, eax                                ; 1EBC _ 89. C2
        mov     eax, dword [ebp-10H]                    ; 1EBE _ 8B. 45, F0
        add     edx, eax                                ; 1EC1 _ 01. C2
        mov     al, byte [ebp-21H]                      ; 1EC3 _ 8A. 45, DF
        mov     byte [edx], al                          ; 1EC6 _ 88. 02
?_124:  inc     dword [ebp-8H]                          ; 1EC8 _ FF. 45, F8
?_125:  mov     eax, dword [ebp-14H]                    ; 1ECB _ 8B. 45, EC
        mov     eax, dword [eax+4H]                     ; 1ECE _ 8B. 40, 04
        cmp     dword [ebp-8H], eax                     ; 1ED1 _ 39. 45, F8
        jl      ?_123                                   ; 1ED4 _ 0F 8C, FFFFFF78
        inc     dword [ebp-0CH]                         ; 1EDA _ FF. 45, F4
?_126:  mov     eax, dword [ebp-14H]                    ; 1EDD _ 8B. 45, EC
        mov     eax, dword [eax+8H]                     ; 1EE0 _ 8B. 40, 08
        cmp     dword [ebp-0CH], eax                    ; 1EE3 _ 39. 45, F4
        jl      ?_122                                   ; 1EE6 _ 0F 8C, FFFFFF4F
        inc     dword [ebp-4H]                          ; 1EEC _ FF. 45, FC
?_127:  mov     eax, dword [ebp+8H]                     ; 1EEF _ 8B. 45, 08
        mov     eax, dword [eax+0CH]                    ; 1EF2 _ 8B. 40, 0C
        cmp     dword [ebp-4H], eax                     ; 1EF5 _ 39. 45, FC
        jle near      ?_121                                   ; 1ef8 _ 0f 8e, ffffff1a
        nop                                             ; 1EFE _ 90
        nop                                             ; 1EFF _ 90
        leave                                           ; 1F00 _ C9
        ret                                             ; 1F01 _ C3
...
?_139:  db 00H, 00H, 00H, 00H, 00H, 00H, 00H, 00H       ; 0007 _ ........
